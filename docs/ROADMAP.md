...
5. [ ] Add rate limiting, idempotency, and abuse controls for messages, orders, file uploads, and AI tasks (order/message idempotency plus message/AI rate limits implemented; order rate limits and general upload controls pending).
